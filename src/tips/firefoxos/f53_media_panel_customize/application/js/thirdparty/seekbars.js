...
utils.seekbars = (function() {
  ...
  Slider.prototype = {
    ...
    updateUI: function updateUI() {
      ...
      this.handler.style.left = (deltaX + this.progressLeft -
  ...
  return {
    ...
    set: function set(value) {
      ...
      sliders[0].placeHandler(value);
    }, 

    getSeek: function getSeek(){
      return sliders[0].progress.value;
    },
